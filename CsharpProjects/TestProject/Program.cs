...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            // trim leading and trailing space from each search term
            ...
            for (int i = 0; i < maxPets; i++)
            {
                ...
                if (ourAnimals[i, 1].Contains("dog"))
                {
                    ...
                    foreach (string search in dogSearches)
                    {
                        ...
                        if (search.Trim() != "" && search != null)
                        {
                            for (int j = 5; j > -1; j--)
                            {
                                ...
                                {
                                    Console.Write($"\rsearching our dog {ourAnimals[i, 3]} for {search} {icon} {j.ToString()}");
                                    Thread.Sleep(250);
                                }
                            ...
                            if (dogDescription.Contains(" " + search + " "))
                            {
                                ...
                                Console.WriteLine($"\rOur dog {ourAnimals[i, 3]} matches your search for {search.Trim()}");
                    ...
                    {
                        Console.WriteLine($"\r{ourAnimals[i, 3]} ({ourAnimals[i, 0].ToString()})\n{dogDescription}\n");
                    }
